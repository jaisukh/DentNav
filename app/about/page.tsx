...
import SplashCursor from "@/components/about/SplashCursor";
  ...
  return (
    <div className="flex min-h-full flex-col bg-sky-50 text-dent-ink">
      ...
      <main className="flex-1">
        ...
        <div className="relative isolate bg-gradient-to-b from-sky-20 via-white to-sky-50">
        ...
        <section className="border-y border-[#E2E8F0] bg-white">
          ...
          <div
            className="pointer-events-none absolute inset-0 z-20 min-h-full overflow-hidden"
            aria-hidden
          >
            <SplashCursor />
          </div>
