...
const analysisNavItem = {
  ...
  inactiveClass: "text-dent-ink hover:bg-dent-badge-bg/60 hover:text-dent-ink",
  activeClass: "bg-dent-ink text-white shadow-[inset_0_0_0_1px_rgba(255,255,255,0.10)]",
  icon: (
    <svg viewBox="0 0 24 24" fill="none" className="h-3.5 w-3.5 shrink-0" aria-hidden>
      <path
...
export function LandingSidebar() {
  ...
  const { hasPaid } = useAuthStatus();
  const items = hasPaid ? [...navItems, analysisNavItem] : navItems;
